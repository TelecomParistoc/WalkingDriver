...
var lib = ffi.Library('libwalkingdriver', {
    ...
    'AX12setMode': [ 'void', ['uint8', 'int'] ],
    'AX12setSpeed': [ 'void', ['uint8', 'double'] ],
    'AX12setTorque': [ 'void', ['uint8', 'double'] ],
    'AX12setLED': [ 'void', ['uint8', 'int'] ],
    'AX12move': [ 'void', ['uint8', 'double', simpleCallback] ],
    'AX12cancelCallback': [ 'void', ['uint8'] ],
    'AX12turn': [ 'void', ['uint8', 'double'] ],
    'AX12resetAll': [ 'void', [] ]
});
var sensorsCallback;
